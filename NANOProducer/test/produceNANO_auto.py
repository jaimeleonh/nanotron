...
if len(options.inputFiles) > 0:
    process.source = cms.Source("PoolSource",
        ...
        #eventsToSkip = cms.untracked.VEventRange('1:842-1:842'),
    )
else:
    process.source = cms.Source("PoolSource",
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('/vols/cms/jleonhol/samples/UL2018/%s/nano_%s.root' % (options.filename, options.number)),
...
# ========================================================================
    ...
    # B-parking additions
    process.llpnanoAOD_step += process.linkedObjects + process.muonBParkSequence + process.muonBParkTables + process.muonTriggerMatchedTables + process.triggerObjectBParkTables + process.muonVertexSequence
